...
func InitApp() *server.Server {
	...
	commentService := service.NewCommentService(commentDao, userRepo, interactionRepo, logger, mqHdl, subjectGetter)
	...
	interactionService := service.NewInteractionService(interactionRepo, mqHdl, logger, subjectGetter)
